									...
									<div class="mfp-gallery">
										<div class="dlab-box">
											<div class="dlab-thum-bx">
												<img src="../images/blood-serum.webp" alt="">
					...
					<div class="col-md-7 col-lg-7 col-sm-12">
						<form method="post" class="cart sticky-top">
							<div class="dlab-post-title">
								<h3 class="post-title m-b10"><a href="javascript:void(0);" data-i18n="product.name">细胞冻存液</a></h3>
								<p class="m-b10 m-t10" data-i18n="product.intro">是一种无血清，通用于各种动物细胞株（肿瘤细胞和常规细胞）， 冻存细胞可在-80℃长期保存（>5 年）。配方成分明确，不含动物来源性蛋白， 不含血清，可减少各类细菌、病毒和支原体等污染，保证冻存细胞的安全。该冻存液含 DMSO、 葡萄糖等各种细胞营养成分，提高细胞存活率和活力，亦适合于无血清培养细胞和蛋白表达细胞。</p>
...
<script>
  ...
  async function loadI18n(lang) {
    ...
    // 你的页面字典（改成你的实际文件名）
    const pagePath   = ROOT + `content/products/Frozen-Cell-Suspension.${lang}.json`;
    const pageZh     = ROOT + `content/products/Frozen-Cell-Suspension.zh.json`;
