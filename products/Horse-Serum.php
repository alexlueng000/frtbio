									...
									<div class="mfp-gallery">
										<div class="dlab-box">
											<div class="dlab-thum-bx">
												<img src="../images/products/horse-serum.webp" alt="">
					...
					<div class="col-md-7 col-lg-7 col-sm-12">
						<form method="post" class="cart sticky-top">
							<div class="dlab-post-title">
								<h3 class="post-title m-b10"><a href="javascript:void(0);" data-i18n="product.name">供体马血清(Donor Horse Serum -Equine Serum)</a></h3>
								<p class="m-b10 m-t10" data-i18n="product.intro">Front的供体马血清是采自中国、美国、澳洲或新西兰，有兽医定期检查及监控的牛群。马血清非常适合用作细胞培养基和兽医生物制品。</p>
...
<script>
  ...
  async function loadI18n(lang) {
    ...
    // 你的页面字典（改成你的实际文件名）
    const pagePath   = ROOT + `content/products/Horse-Serum.${lang}.json`;
    const pageZh     = ROOT + `content/products/Horse-Serum.zh.json`;
