        ...
        <div class="dlab-bnr-inr overlay-black-middle bg-pt" style="background-image:url(../images/banner/banner-1.webp);">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white" data-i18n="meta.title">产品详情</h1>
					<!-- Breadcrumb row -->
									...
									<div class="mfp-gallery">
										<div class="dlab-box">
											<div class="dlab-thum-bx">
												<img src="../images/products/new-product2-side.webp" alt="">
					...
					<div class="col-md-7 col-lg-7 col-sm-12">
						<form method="post" class="cart sticky-top">
							<div class="dlab-post-title">
								<h3 class="post-title m-b10"><a href="javascript:void(0);" data-i18n="product.name">Front Biomedical 超优级胎牛血清 (FBS, Exceptional )</a></h3>
								<div style="flex:1;font-size:20px;line-height:1.6; margin-top:20px;">
									<div style="font-size:16px;">
										<b data-i18n="products.items.1.fields.partno">产品货号</b>：
										<span data-i18n="products.items.1.desc.desc_partno">FBS-FFU   FBS-FFB</span>
									</div>
									<div style="font-size:16px; margin-top:10px;">
										<b data-i18n="products.items.1.fields.basic">基础信息</b>：
										<span data-i18n="products.items.1.desc.desc_basic">普适性强，适用于培养常规原代细胞、干细胞、免疫细胞及难培养细胞。
										1、原代细胞代表：上皮细胞、平滑肌细胞、内皮细胞、黑色素细胞、心肌细胞、巨噬细胞等；2、干细胞代表：NSC、UC·MSCs；3、免疫细胞代表：H9、CTLL-2、人外周血来源NK细胞、人外周血来源T细胞等；4、难培养细胞：乳腺癌细胞、结直肠腺癌细胞、胃腺癌细胞、肺腺癌细胞、肝癌细胞等。</span>
									</div>
									<div style="font-size:16px; margin-top:10px;">
										<b data-i18n="products.items.1.fields.cells">适用细胞举例</b>：
										<span data-i18n="products.items.1.desc.desc_cells">Hela、HCC1937、HT22、Caov3、NCI-H460、NCI-H146、CT26.WT、NRK-52E、A375、H9C2、L929、NC1N87、C0L0 205、BEP2D、HMy-2CIR、MDA-MB-453、MS751、RL95-2、SW 780、22RV1、PK-15、A3、NCI-H82、OVCAR-3、BRL、Calu-3、SNU-387、MCF7等细胞。</span>
									</div>
								</div>
							</div>
                    ...
                    <div class="col-lg-12">
                        <div class="dlab-tabs product-description tabs-site-button">
                            <ul class="nav nav-tabs ">
                                ...
                                <li><a data-bs-toggle="tab" href="#developement-1" class="active" data-i18n="tabs.examples"><i class="fas fa-cog"></i>应用实例</a></li>
								<div id="content-dental" class="tab-pane">
                                        <h4 data-i18n="examples.cartilage.title">原代软骨细胞</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                                    <div class="dlab-box img-content-style-1">
														...
														<h6 data-i18n="examples.cartilage.labels.0">对照（P3、100×、48h）</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                                    <div class="dlab-box img-content-style-1">
														...
														<h6 data-i18n="examples.cartilage.labels.2">对照（P6、100×、48h） </h6>
                                                    </div>
                                                </div>
										...
										<h4 data-i18n="examples.ctll2.title">小鼠T淋巴细胞（CTLL-2）</h4>
                                        <!-- <p>牙科领域聚焦硬组织微结构解析。通过扫描牙齿及颌骨标本，可评估种植体骨结合率、牙本质微裂扩展、龋齿矿化层破坏程度以及正畸治疗对牙槽骨微孔结构的影响，为口腔修复提供三维力学依据。</p> -->
                                        <div class="section-content p-b0">
                                            <div class="row">
                                                <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                                    <div class="dlab-box img-content-style-1">
														...
														<h6 data-i18n="examples.ctll2.labels.0">对照（P3、100×、72h）</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                                    <div class="dlab-box img-content-style-1">
														...
														<h6 data-i18n="examples.ctll2.labels.1">FBS-E500A（P3、100×、72h）</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                                    <div class="dlab-box img-content-style-1">
														...
														<h6 data-i18n="examples.ctll2.labels.2">对照（P6、100×、72h） </h6>
                                                    </div>
                                                </div>
                                        ...
                                        <h4 data-i18n="examples.h9.title">人淋巴细胞系（H9）</h4>
                                        <!-- <p>牙科领域聚焦硬组织微结构解析。通过扫描牙齿及颌骨标本，可评估种植体骨结合率、牙本质微裂扩展、龋齿矿化层破坏程度以及正畸治疗对牙槽骨微孔结构的影响，为口腔修复提供三维力学依据。</p> -->
                                        <div class="section-content p-b0">
                                            <div class="row">
                                                <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                                    <div class="dlab-box img-content-style-1">
														...
														<h6 data-i18n="examples.h9.labels.0">对照（P3、100×、72h）</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                                    <div class="dlab-box img-content-style-1">
														...
														<h6 data-i18n="examples.h9.labels.2">对照（P6、100×、72h） </h6>
                                                    </div>
                                                </div>
...
<script>
  ...
  async function loadI18n(lang) {
    ...
    // 你的页面字典（改成你的实际文件名）
    const pagePath   = ROOT + `content/products/Front-Biomed-Exceptional.${lang}.json`;
    const pageZh     = ROOT + `content/products/Front-Biomed-Exceptional.zh.json`;
