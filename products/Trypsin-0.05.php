					...
					<div class="col-md-7 col-lg-7 col-sm-12">
						<form method="post" class="cart sticky-top">
							<div class="dlab-post-title">
								...
								<p class="m-b10 m-t10" data-i18n="product.intro">浓度0.05%，含有EDTA和酚红，不含有钙、镁离子。该产品 经过严格的过滤除菌，适用于组织和单层细胞的分离。</p>
...
<script>
  ...
  async function loadI18n(lang) {
    ...
    // 你的页面字典（改成你的实际文件名）
    const pagePath   = ROOT + `content/products/Trypsin-0.05.${lang}.json`;
    const pageZh     = ROOT + `content/products/Trypsin-0.05.zh.json`;
