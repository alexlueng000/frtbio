                ...
                <div class="dlab-bnr-inr-entry">
					...
					<div class="breadcrumb-row">
						<ul class="list-inline">
							...
							<li><a href="../serums" data-i18n="breadcrumb.center">产品中心</a></li>
						</ul>
					</div>
					<!-- Breadcrumb row END -->
                </div>
									...
									<div class="mfp-gallery">
										<div class="dlab-box">
											<div class="dlab-thum-bx">
												<img src="../images/products/pig-serum.webp" alt="">
					...
					<div class="col-md-7 col-lg-7 col-sm-12">
						<form method="post" class="cart sticky-top">
							<div class="dlab-post-title">
								<h3 class="post-title m-b10"><a href="javascript:void(0);" data-i18n="product.name">猪血清(Pig Serum-Porcine Serum)</a></h3>
								<p class="m-b10 m-t10" data-i18n="product.intro">作为少数天然猪血清供应商之一，Front的猪血清源自美国农场。Front从未用抗生素或激素处理的动物收集和生产猪血清。这种独特的猪血清用作细胞培养基特别是疫苗生产中非常理想。有机猪血清经过200nm无菌过滤，具有低血红蛋白水平.猪血清非常适合用于疫苗生产以及细胞培养。</p>
							...
							<div class="btn-group product-item-size" data-bs-toggle="buttons">
								<button class="site-button orange m-r15" type="button" data-bs-toggle="modal" data-bs-target="#infoModal" data-i18n="products.items.1.spec.consult">立即咨询</button>
							</div>
							<!-- 模态框 -->
...
<script>
  ...
  async function loadI18n(lang) {
    ...
    // 你的页面字典（改成你的实际文件名）
    const pagePath   = ROOT + `content/products/Pig-Serum.${lang}.json`;
    const pageZh     = ROOT + `content/products/Pig-Serum.zh.json`;
