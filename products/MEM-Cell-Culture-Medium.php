					...
					<div class="col-md-7 col-lg-7 col-sm-12">
						<form method="post" class="cart sticky-top">
							<div class="dlab-post-title">
								<h3 class="post-title m-b10"><a href="javascript:void(0);">MEM培养基</a></h3>
								<p class="m-b10 m-t10">是一种常用的细胞培养基，可改良以支持多种哺乳动物细胞培养类型和应用。相比其他培养基之所以具有独特的效果，是因为其中含有还原剂谷胱甘肽和高浓度的维生素。</p>
