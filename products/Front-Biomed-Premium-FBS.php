									...
									<div class="mfp-gallery">
										<div class="dlab-box">
											<div class="dlab-thum-bx">
												<img src="../images/products/guochanteji-side.webp" alt="">
					...
					<div class="col-md-7 col-lg-7 col-sm-12">
						<form method="post" class="cart sticky-top">
							<div class="dlab-post-title">
								<h3 class="post-title m-b10"><a href="javascript:void(0);" data-i18n="product.name">Front Biomedical 优级胎牛血清 (FBS, Premium)</a></h3>
								<div style="flex:1;font-size:20px;line-height:1.6; margin-top:20px;">
									...
									<div style="font-size:16px; margin-top:10px;">
										...
										<span data-i18n="products.items.1.desc.desc_basic">来源于国内优质天然牧场6-8月龄健康胎牛
                                            适用细胞范围推荐：
                                            适用于培养绝大多数肿瘤细胞和规模化生产细胞，部分原代细胞和部分免疫细胞等。
                                        </span>
									</div>
									<div style="font-size:16px; margin-top:10px;">
                    ...
                    <div class="col-lg-12">
                        <div class="dlab-tabs product-description tabs-site-button">
                            ...
                            <div id="content-dental" class="tab-pane">
                                <h4 data-i18n="examples.a549.title">人非小细胞肺癌细胞（A549）</h4>
                                ...
                                <div class="section-content p-b0">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic1.webp" alt="">
                                                </div>
                                                <h6 data-i18n="examples.a549.labels.0">对照（P3、100×、72h）</h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic2.webp" alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic3.webp" alt="">
                                                </div>
                                                <h6 data-i18n="examples.a549.labels.2">对照（P6、100×、72h） </h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic4.webp" alt="">
                                                </div>
                                ...
                                <h4 data-i18n="examples.hek293t.title">人胚肾细胞（293T）</h4>
                                <!-- <p>牙科领域聚焦硬组织微结构解析。通过扫描牙齿及颌骨标本，可评估种植体骨结合率、牙本质微裂扩展、龋齿矿化层破坏程度以及正畸治疗对牙槽骨微孔结构的影响，为口腔修复提供三维力学依据。</p> -->
                                <div class="section-content p-b0">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic5.webp" alt="">
                                                </div>
                                                <h6 data-i18n="examples.hek293t.labels.0">对照（P3、100×、72h）</h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic6.webp" alt="">
                                                </div>
                                                <h6>FBS-FFU （P3、100×、72h）</h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic7.webp" alt="">
                                                </div>
                                                <h6 data-i18n="examples.hek293t.labels.2">对照（P6、100×、72h） </h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic8.webp" alt="">
                                                </div>
                                            <h6>FBS-FFU （P6、100×、72h）</h6>
                                            </div>
                                        </div>
                                ...
                                <h4 data-i18n="examples.ct26.title">小鼠结肠癌细胞（CT26.WT）</h4>
                                <!-- <p>牙科领域聚焦硬组织微结构解析。通过扫描牙齿及颌骨标本，可评估种植体骨结合率、牙本质微裂扩展、龋齿矿化层破坏程度以及正畸治疗对牙槽骨微孔结构的影响，为口腔修复提供三维力学依据。</p> -->
                                <div class="section-content p-b0">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic9.webp" alt="">
                                                </div>
                                                <h6 data-i18n="examples.ct26.labels.0">对照（P3、100×、72h）</h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic10.webp" alt="">
                                                </div>
                                                <h6>FBS-FFU （P3、100×、72h）</h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic11.webp" alt="">
                                                </div>
                                                <h6 data-i18n="examples.ct26.labels.2">对照（P6、100×、72h） </h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 ">     
                                                    <img src="../images/products/product4/pic12.webp" alt="">
                                                </div>
                                            <h6>FBS-FFU （P6、100×、72h）</h6>
                                            </div>
                                        </div>
                                ...
                                <h4 data-i18n="examples.u373.title">人类胶质母细胞瘤星形细胞瘤细胞（U373）</h4>
                                <!-- <p>牙科领域聚焦硬组织微结构解析。通过扫描牙齿及颌骨标本，可评估种植体骨结合率、牙本质微裂扩展、龋齿矿化层破坏程度以及正畸治疗对牙槽骨微孔结构的影响，为口腔修复提供三维力学依据。</p> -->
                                <div class="section-content p-b0">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic13.webp" alt="">
                                                </div>
                                                <h6 data-i18n="examples.u373.labels.0">对照（P3、100×、72h）</h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic14.webp" alt="">
                                                </div>
                                                <h6>FBS-FFU （P3、100×、72h）</h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic15.webp" alt="">
                                                </div>
                                                <h6 data-i18n="examples.u373.labels.2">对照（P6、100×、72h） </h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                            <div class="dlab-box img-content-style-1">
                                                <div class="dlab-media dlab-img-overlay1 "> 
                                                    <img src="../images/products/product4/pic16.webp" alt="">
                                                </div>
                                            <h6>FBS-FFU （P6、100×、72h）</h6>
                                            </div>
                                        </div>
...
<script>
  ...
  async function loadI18n(lang) {
    ...
    // 你的页面字典（改成你的实际文件名）
    const pagePath   = ROOT + `content/products/Front-Biomed-Premium-FBS.${lang}.json`;
    const pageZh     = ROOT + `content/products/Front-Biomed-Premium-FBS.zh.json`;
