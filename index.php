...
<head>
	...
	<meta property="og:title" content="弗劳恩生物">
	<meta property="og:description" content="弗劳恩生物">
	...
	<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@100;200;300;400;500;600;700;800;900&family=Open+Sans:wght@300;400;600;700;800&family=Playfair+Display:wght@400;700;900&family=Poppins:wght@100;200;300;400;500;600;700;800;900&family=Raleway:wght@100;200;300;400;500;600;700;800;900&family=Roboto:wght@100;300;400;500;700;900&family=Roboto+Condensed:wght@300;400;700&display=swap" rel="stylesheet">
	...
	.navbar-nav > li {
		margin-right: 40px; /* 控制一级菜单横向间距，默认可以从20px调到40px */
	}

	nav .navbar-nav li > a {
		font-size: 8px; /* 调小字体 */
		padding: 4px 8px; /* 减少上下间距 */
		display: block;
	...
	li ul {
		padding-left: 0; /* 移除内边距以靠近左边 */
		margin: 0;
		list-style: none;
	}

	li ul li a {
		font-size: 10px; /* 子项再小一点 */
		padding: 3px 12px; /* 控制子项间距 */
		display: block;
		text-align: left;
	}
							...
							>
								<div >
									...
									<div class="text-center">
										...
										<a href="products/Front-Biomed-Premium-Imported-FBS" class="site-button btnhover10 mb-4" style="background-color: #FF8500; color: #fff; padding: 8px 16px; border-radius: 6px; display: inline-block;" data-i18n-html="common.view">查看详情</a>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-3 col-md-6 col-sm-12 col-12 wow bounceInUp" data-wow-duration="2s" data-wow-delay="0.3s" style=" box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);  transition: transform 0.3s ease, box-shadow 0.3s ease; ">
								<div class="product-card dlab-post-media" >
									...
									<div class="text-center">
										...
										<a href="products/Front-Biomed-Superior-Grade-Fetal-Bovine-Serum" class="site-button btnhover10 mb-4" style="background-color: #FF8500; color: #fff; padding: 8px 16px; border-radius: 6px; display: inline-block;" data-i18n-html="common.view">查看详情</a>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-3 col-md-6 col-sm-12 col-12 wow bounceInUp" data-wow-duration="2s" data-wow-delay="0.3s" style=" box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);  transition: transform 0.3s ease, box-shadow 0.3s ease; ">
								<div class="product-card dlab-post-media" >
									...
									<div class="text-center">
										...
										<a href="products/Front-Biomed-Exceptional" class="site-button btnhover10 mb-4" style="background-color: #FF8500; color: #fff; padding: 8px 16px; border-radius: 6px; display: inline-block;" data-i18n-html="common.view">查看详情</a>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-3 col-md-6 col-sm-12 col-12 wow bounceInUp" data-wow-duration="2s" data-wow-delay="0.3s" style=" box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);  transition: transform 0.3s ease, box-shadow 0.3s ease; ">
								<div class="product-card dlab-post-media" >
									...
									<div class="text-center">
										...
										<a href="products/Front-Biomed-Premium-FBS" class="site-button btnhover10 mb-4" style="background-color: #FF8500; color: #fff; padding: 8px 16px; border-radius: 6px; display: inline-block;" data-i18n-html="common.view">查看详情</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="row m-b30">
						<div id="lightgallery" class="dlab-gallery-listing row sp15 gallery">
							<div class="col-lg-2 col-md-4 col-sm-4 col-6 wow bounceInUp" data-wow-duration="2s" data-wow-delay="0.1s">
							...
							<div class="col-lg-2 col-md-4 col-sm-4 col-6 wow bounceInUp" data-wow-duration="2s" data-wow-delay="0.2s">
								<div class="dlab-box m-b15">
									<div class="dlab-img-overlay4 dlab-img-effect zoom"> 
										<a href="javascript:void(0);">
							...
							<div class="col-lg-2 col-md-4 col-sm-4 col-6 wow bounceInUp" data-wow-duration="2s" data-wow-delay="0.3s">
								<div class="dlab-box m-b15">
									<div class="dlab-img-overlay4 dlab-img-effect zoom"> 
										<a href="javascript:void(0);">
							...
							<div class="col-lg-2 col-md-4 col-sm-4 col-6 wow bounceInUp" data-wow-duration="2s" data-wow-delay="0.4s">
								<div class="dlab-box m-b15">
									<div class="dlab-img-overlay4 dlab-img-effect zoom"> 
										<a href="javascript:void(0);">
							...
							<div class="col-lg-2 col-md-4 col-sm-4 col-6 wow bounceInUp" data-wow-duration="2s" data-wow-delay="0.5s">
								<div class="dlab-box m-b15">
									<div class="dlab-img-overlay4 dlab-img-effect zoom"> 
										<a href="javascript:void(0);">
							...
							<div class="col-lg-2 col-md-4 col-sm-4 col-6 wow bounceInUp" data-wow-duration="2s" data-wow-delay="0.6s">
								<div class="dlab-box m-b15">
									<div class="dlab-img-overlay4 dlab-img-effect zoom"> 
										<a href="javascript:void(0);">
