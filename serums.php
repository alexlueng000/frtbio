							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12">
									<div class="d-flex align-items-start">  <!-- align-items-start 保证顶部对齐 -->
										...
										<div style="margin-right: 30px; width: 200px; height: 200px; border: 2px solid #ddd; display: flex; justify-content: center; align-items: center; overflow: hidden;">
											<a >
												<img src="images/进口新西兰特级胎牛血清.jpg" class="rounded" alt="" style="max-width: 100%; height: 100%;">
											</a>
										</div>
										<!-- 文字内容部分 -->
									...
									<div class="d-flex align-items-start">  <!-- align-items-start 保证顶部对齐 -->
										...
										<div style="margin-right: 30px; width: 200px; height: 200px; border: 2px solid #ddd; display: flex; justify-content: center; align-items: center; overflow: hidden;">
											<a href="fetal-bovine-serum.html">
												<img src="images/特级国产胎牛血清.jpg" class="rounded" alt="" style="max-width: 100%; height: 100%;">
											</a>
										</div>
										<!-- 文字内容部分 -->
										<div class="dlab-post-title" style="flex: 1;">
                                ...
                                <div class="col-lg-12 col-md-12">
									<div class="d-flex align-items-start">  <!-- align-items-start 保证顶部对齐 -->
										...
										<div style="margin-right: 30px; width: 200px; height: 200px; border: 2px solid #ddd; display: flex; justify-content: center; align-items: center; overflow: hidden;">
											<a href="fetal-bovine-serum.html">
												<img src="images/优级国产胎牛血清.jpg" class="rounded" alt="" style="max-width: 100%; height: 100%;">
											</a>
										</div>
										<!-- 文字内容部分 -->
										<div class="dlab-post-title" style="flex: 1;">
									...
									<div class="d-flex align-items-start">  <!-- align-items-start 保证顶部对齐 -->
										...
										<div class="dlab-post-title" style="flex: 1;">
											...
											<div style="display: flex; justify-content: space-between; align-items: flex-start;">
												...
												<!-- 文字部分 -->
												<p style="flex: 1; margin-left: 20px; font-size: 14px">500mL、1L、3.5L</p>
											</div>
										</div>
									</div>
								</div>
