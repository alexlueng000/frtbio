								...
								<div class="widget recent-posts-entry">
									<div class="dlab-accordion advanced-search toggle" id="accordion1">
										<div class="panel">
											<div class="">
												<h4 class="acod-title" > 
													<a  href="#categories" style="color: #FF8500;">
														产品中心
													</a> 
												</h5>
											</div>
							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12" style="margin-bottom: 20px;">
									<div class="d-flex align-items-start">  <!-- align-items-start 保证顶部对齐 -->
										...
										<div style="margin-right: 30px; width: 200px; height: 200px; border: 2px solid #ddd; display: flex; justify-content: center; align-items: center; overflow: hidden;">
											<a >
												<img src="images/serum-product1.jpg" class="rounded" alt="" style="max-width: 100%; height: 100%;">
											</a>
										</div>
										<!-- 文字内容部分 -->
								...
								<div class="col-lg-12 col-md-12" style="margin-bottom: 20px;">
									<div class="d-flex align-items-start">  <!-- align-items-start 保证顶部对齐 -->
										...
										<div style="margin-right: 30px; width: 200px; height: 200px; border: 2px solid #ddd; display: flex; justify-content: center; align-items: center; overflow: hidden;">
											<a >
												<img src="images/serum-product2.jpg" class="rounded" alt="" style="max-width: 100%; height: 100%;">
											</a>
										</div>
										<!-- 文字内容部分 -->
										<div class="dlab-post-title" style="flex: 1;">
									...
									<div class="d-flex align-items-start">  <!-- align-items-start 保证顶部对齐 -->
										...
										<div class="dlab-post-title" style="flex: 1;">
											...
											<div style="display: flex; justify-content: space-between; align-items: flex-start;">
												...
												<!-- 文字部分 -->
												<p style="flex: 1; margin-left: 20px; font-size: 14px">Front Biomed优级胎牛血清采用经过严格筛选的最优质的新西兰或国产胎牛血清。其采集方法，加工过程，检定标准与美国原产优等胎牛血清完全一致。经过3次100 nm过滤，其质量相当或优于Gibco南美/依科赛南美等同类产品。</p>
											</div>
											<div style="display: flex;  align-items: flex-start;">
												<!-- 按钮部分 -->
												<button class="site-button orange radius-xl m-r15" type="button" style="padding: 5px 15px; font-size: 14px;">规格</button>
								...
								<!-- product 5 新生牛血清(Newborn Calf Serum-NBCS(Bovine)) -->
								<div class="col-lg-12 col-md-12" style="margin-bottom: 20px;">
									<div class="d-flex align-items-start">  <!-- align-items-start 保证顶部对齐 -->
										<!-- 图片部分 -->
										<div style="margin-right: 30px; width: 200px; height: 200px; border: 2px solid #ddd; display: flex; justify-content: center; align-items: center; overflow: hidden;">
											<a >
												<img src="images/xq-product1.jpg" class="rounded" alt="" style="max-width: 100%; height: 100%;">
											</a>
										</div>
										<!-- 文字内容部分 -->
										<div class="dlab-post-title" style="flex: 1;">
								...
								<!-- product 6 猪血清(Pig Serum-Porcine Serum) -->
								<div class="col-lg-12 col-md-12" style="margin-bottom: 20px;">
									<div class="d-flex align-items-start">  <!-- align-items-start 保证顶部对齐 -->
										<!-- 图片部分 -->
										<div style="margin-right: 30px; width: 200px; height: 200px; border: 2px solid #ddd; display: flex; justify-content: center; align-items: center; overflow: hidden;">
										...
										<div class="dlab-post-title" style="flex: 1;">
											...
											<div style="display: flex; justify-content: space-between; align-items: flex-start;">
												...
												<!-- 文字部分 -->
												<p style="flex: 1; margin-left: 20px; font-size: 14px">作为少数天然猪血清供应商之一，Front的猪血清源自美国农场。Front从未用抗生素或激素处理的动物收集和生产猪血清。这种独特的猪血清用作细胞培养基特别是疫苗生产中非常理想。有机猪血清经过200nm无菌过滤，具有低血红蛋白水平.猪血清非常适合用于疫苗生产以及细胞培养。</p>
											</div>
											<div style="display: flex;  align-items: flex-start;">
												<!-- 按钮部分 -->
												<button class="site-button orange radius-xl m-r15" type="button" style="padding: 5px 15px; font-size: 14px;">规格</button>
								...
								<!-- product 7 供体马血清(Donor Horse Serum -Equine Serum) -->
								<div class="col-lg-12 col-md-12" style="margin-bottom: 20px;">
									<div class="d-flex align-items-start">  <!-- align-items-start 保证顶部对齐 -->
										<!-- 图片部分 -->
										<div style="margin-right: 30px; width: 200px; height: 200px; border: 2px solid #ddd; display: flex; justify-content: center; align-items: center; overflow: hidden;">
