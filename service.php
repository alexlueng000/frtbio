    ...
    <div class="page-content bg-white">
		...
		<div style="background-image: url('images/service-banner.jpg'); height: 500px; background-size: cover; background-position: center; position: relative;">
			<div class="container h-100 d-flex flex-column justify-content-center align-items-center text-white text-center">
				...
				<h3 style="font-size: 24px; margin-top: 20px; font-family: 'Poppins',sans-serif; font-weight: 600;">精准定制 · 严选品质 · 突破创新</h3>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-6 col-md-12 bg-primary">
						<div class="max-w700 m-auto p-tb50 p-lr20">
							...
							<div class="icon-bx-wraper m-b30 left bg-white" >
								<div class="icon-md"> 
									<a href="javascript:void(0);" class="icon-cell text-black">
							...
							<div class="icon-bx-wraper m-b30 left bg-white">
								...
								<div class="icon-content">
									...
									<ul class="list-chevron-circle orange text-black" style="font-size: 20px;">
                                        ...
                                        <li>从出厂到用户手里最多经历三重检验（出厂检测+国内外实验室检测）</li>
                                    </ul>
								</div>
							</div>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 col-md-12 m-b30 wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.3s">
							<div class="our-story">
								<span style="color: #FF8500;">重构细胞生长的黄金环境</span>
								<h2 class="title">无血清培养基研发</h2>
								<!-- <h4 class="title">我们致力于打造高效、可靠的生物工程解决方案。</h4> -->
								<p style="color:black; font-size:20px; ">弗劳恩生物通过重组蛋白表达系统的技术应用，可以量产细胞培养所需的各种生长因子（表皮生长因子、成纤维生长因子、类胰岛素生长因子等）；与中国科学院广州生物医药与健康研究院顶级干细胞研究团队合作，可以根据各种细胞株的生长特性开发最合适的无血清培养基。</p>
								<!-- <a href="about-2.html" class="site-button btnhover20">About Us</a> -->

                                <h4 style="color: #182CA7; font-size:20px;">中科院联合开发平台</h4>
                                <div>
                                    <ul style="font-size:20px; color: #000; list-style-type: none; ">
                                        <li>
                                            <div class="icon-md">
                                                <a href="javascript:void(0);" class="icon-cell"><i class="flaticon-robot-arm"></i></a>
                                            </div>干细胞无血清培养基定制开发</li>
                                        <li>
                                            <div class="icon-md">
                                                <a href="javascript:void(0);" class="icon-cell"><i class="flaticon-robot-arm"></i></a>
                                            </div>肿瘤细胞专用无血清配方</li>
                                        <li>
                                            <div class="icon-md">
                                                <a href="javascript:void(0);" class="icon-cell"><i class="flaticon-robot-arm"></i></a>
                                            </div>悬浮/贴壁细胞差异化解决方案</li>
                                        <li>
                                            <div class="icon-md">
                                                <a href="javascript:void(0);" class="icon-cell"><i class="flaticon-robot-arm"></i></a>
                                            </div>化学成分限定培养基（CDM）开发</li>
                                    </ul>
								</div>
							</div>
						</div>
